       ...
       <div id="menuF">
           ...
           <div id="content">
               ...
               <div style="border : 2px black solid; width: 1175px; height: 640px; margin-top: 40px;margin-left: 40px; overflow: hidden; position: relative;">
				<div style="float: left;">
					<div id="imgsize">
						<img id="secimg" alt="" src="${root}/img/${Ilist[0].iname}" onclick="btnClick1()"/>
						<div style="margin-top: 150px;"><a>${Ilist[0].LMtitle}</a></div>
					</div>
					<div id="imgsize" >
						<img id="thimg" alt="" src="${root}/img/${Ilist[1].iname}" onclick="btnClick2()"/>
						<a id="thtext" style="width:149px;height:30px;">${Ilist[1].LMtitle}</a>
					</div>
					<div id="imgsize" >
						<img id="forimg" alt="" src="${root}/img/${Ilist[2].iname}" onclick="btnClick3()"/>
				...
				<div style="position: absolute; margin-top: 250px">
					<div id="imgsize">
						<img id="secimg" alt="" src="${root}/img/${Ilist[3].iname}" onclick="btnClick4()"/>
						<div style="margin-top: 150px;"><a>${Ilist[3].LMtitle}</a></div>
					</div>
					<div id="imgsize" >
						<img id="thimg" alt="" src="${root}/img/${Ilist[4].iname}" onclick="btnClick5()"/>
						<div style="margin-top: 150px;"><a>${Ilist[4].LMtitle}</a></div>
					</div>
					<div id="imgsize" >
						<img id="forimg" alt="" src="${root}/img/${Ilist[5].iname}" onclick="btnClick6()"/>
						<div style="margin-top: 150px;"><a>${Ilist[5].LMtitle}</a></div>
					</div>
				</div>
				<!-- 오른쪽 큰 사진 -->
				<div style="border : 1px black solid; width: 590px; height: 590px; margin-top: 20px;margin-right: 20px; float: right;">
					<img id="mainimg" alt="" src="${root}/img/${Ilist[6].iname}" onclick="btnClick7()"/>
				</div>
				</div></div></div>
        ...
        <div id="zido2" style="width: 466px; height: 250px; border: 0px black solid;">
  		...
  		<div id = "hiden3"style="azimuth:inherit; display: none; border: 2px black solid; width: 500px; height: 560px; position:absolute;" >
	   	...
	   	<div id = "hiden7"style="azimuth:inherit; display: none; border: 2px black solid; width: 500px; height: 550px; display:lnline-block; position:absolute;" >
            <div id="zido7" style="width: 500px; height: 250px; border: 0px black solid; display:lnline-block;">
            <script type="text/javascript">
