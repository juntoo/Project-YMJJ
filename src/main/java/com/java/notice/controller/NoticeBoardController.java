...
public class NoticeBoardController {
	...
	public ModelAndView noticeBoardWriteOk(HttpServletRequest request, HttpServletResponse response, NoticeBoardDto noticeBoardDto) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView noticeBoardUpdateOk(HttpServletRequest request, HttpServletResponse response, NoticeBoardDto noticeBoardDto) {
		ModelAndView mav=new ModelAndView();
		mav.addObject("request", request);
		mav.addObject("noticeBoardDto",noticeBoardDto);
